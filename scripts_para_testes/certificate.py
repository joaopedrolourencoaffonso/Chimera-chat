'''
=> Cliente Smallstep completo
- Esse script é um cliente da step-ca completo, escrito como forma de agilizar o teste de fluxos envolvendo o chimera_identity.py
'''
